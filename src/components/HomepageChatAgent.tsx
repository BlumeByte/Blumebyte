...
const FAQ_RESPONSES: Record<string, { answer: string; links?: { text: string; url: string }[] }> = {
  pricing: {
    answer: "Blumebyte offers flexible pricing: Monthly plan at $3.55/month per employee, or Yearly plan at $2.55/month per employee (billed annually at $30.60/employee). All plans include full access to our comprehensive HR management features.",
    links: [
