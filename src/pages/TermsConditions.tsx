        ...
        <div className="space-y-6">
          ...
          <Card>
            ...
            <CardContent className="space-y-3 text-sm text-muted-foreground">
              ...
              <ul className="list-disc list-inside space-y-1 ml-4">
                <li><strong>Monthly Plan:</strong> $2.59 per employee per month, billed monthly</li>
                <li><strong>Yearly Plan:</strong> $3.59 per employee per month, billed annually ($43.08/employee/year)</li>
