...
import { CheckCircle2, Users, BarChart3, Shield, Clock, FileText, Zap, DollarSign, UserCheck, Trophy, ChevronDown, Star, TrendingUp, Award, MessageSquare, BookOpen, ChevronLeft, ChevronRight, Play, RotateCcw } from 'lucide-react';
...
const GAME_TICK_MS = 135; // game speed: ~7 ticks/second
...
function SnakeMiniGame() {
  ...
  useEffect(() => {
    draw();
    return () => {
      if (stateRef.current.intervalId) clearInterval(stateRef.current.intervalId);
    };
  }, [draw]);
...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen public-page-bg overflow-x-hidden">
      ...
      {/* ── 1b. MINI GAME ── */}
      <FadeSection className="py-12 border-b border-black/6">
